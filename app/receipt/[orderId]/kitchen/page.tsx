...
import { KitchenTicket } from "@/components/receipt/kitchen-ticket";

export default function KitchenPrintPage({ params }: { params: { orderId: string } }) {
  ...
  if (orderLoading) {
    return <div className="p-4 text-sm text-muted-foreground">Preparing kitchen ticket…</div>;
  }
  ...
  return (
    <div className="p-2">
      <KitchenTicket order={printableOrder} tableNumber={table?.tableNumber} />
